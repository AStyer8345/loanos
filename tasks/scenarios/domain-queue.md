...
- ~~**Share page: social proof block** — "X borrowers in Austin chose a 30yr fixed this month" — purely illustrative, compliance-safe framing~~ ✅ DONE 2026-04-14 AM

---

## Tier 6 — Borrower Experience Depth (active)

- ~~**DetailAccordion cleanup** — remove "Full Scenario Comparison" item now that comparison table is persistent; auto-hide component when no horizon data~~ ✅ DONE 2026-04-15 AM
- ~~**Pre-generated Borrower Q&A** — 5 scenario-specific Q&A pairs generated by Claude at save time, stored in `scenarios.borrower_qa`, rendered as expandable accordion on share page (print:hidden)~~ ✅ DONE 2026-04-15 AM
- ~~**Mobile builder quick-input** — 4-field card (price/down%/rate/term) shown md:hidden at top of ScenarioBuilder; live P&I preview; "Get Share Link" calls calculate+save and returns /share/[token] inline in one tap~~ ✅ DONE 2026-04-17 AM
- ~~**Backfill Q&A for existing scenarios** — gold banner + "Generate Q&A (N)" button in scenarios list; `POST /api/scenarios/backfill-qa` processes all Q&A-null scenarios in parallel chunks of 3~~ ✅ DONE 2026-04-16 AM
...
## Tier 8 — Post-Beta Engagement + Personalization (defined 2026-04-20, build after May 1)
...
- ~~**SMS share from ActionsBar** — "Text Borrower" button alongside "Email Borrower" in~~
  ...
  pre-filled via `sms:+1XXXXXXXXXX?body=Here+are+your+loan+options...` URL scheme.
