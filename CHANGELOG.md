...
Validation: full application build, targeted lint, local sample-data browser checks for desktop/mobile, search beyond the initial page, load-more, view switching, read failure/retry, and detail-panel layout. Scoped production count query verified exact totals with a limited result page.
