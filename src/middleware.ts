...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$|api/agents/.*|api/activity|api/contacts/web-lead|api/marketing/log-social-post|onboarding|share/.*|api/share/.*).*)',
  ],
}
