...
-- Seed drip campaign definitions and steps for Adam Styer | HyperSmart Home Loans
...
VALUES (
  (SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1),
  'Past Client Retention',
  'past_client',
  'active',
...
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Past Client Retention' LIMIT 1),
...
INSERT INTO drip_steps (org_id, campaign_id, step_order, name, trigger_type, trigger_config, skeleton, channel, requires_approval, tone)
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Lead — Ghost Referral' LIMIT 1),
...
INSERT INTO drip_steps (org_id, campaign_id, step_order, name, trigger_type, trigger_config, skeleton, channel, requires_approval, tone)
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Lead — Incomplete App' LIMIT 1),
...
INSERT INTO drip_steps (org_id, campaign_id, step_order, name, trigger_type, trigger_config, skeleton, channel, requires_approval, tone)
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Lead — Went Quiet' LIMIT 1),
...
INSERT INTO drip_steps (org_id, campaign_id, step_order, name, trigger_type, trigger_config, skeleton, channel, requires_approval, tone)
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Realtor Relationships' LIMIT 1),
...
INSERT INTO drip_steps (org_id, campaign_id, step_order, name, trigger_type, trigger_config, skeleton, channel, requires_approval, tone)
VALUES
  ((SELECT id FROM organizations WHERE name = 'Adam Styer | HyperSmart Home Loans' LIMIT 1), (SELECT id FROM drip_campaigns WHERE name = 'Long-Term Nurture' LIMIT 1),
