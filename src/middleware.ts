...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$|api/agents/.*|api/contacts/web-lead|api/outlook-sync|api/marketing/log-social-post|onboarding).*)',
  ],
}
