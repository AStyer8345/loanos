...
export default async function CommissionReportPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] p-6">
      ...
      <h1 className="text-xl font-mono font-bold text-foreground mb-1">Commission Report</h1>
      <p className="text-xs font-mono text-muted-foreground mb-6">{thisYear} YTD &middot; {funded.length} loans &middot; {fmt(totalCommission)} gross commission</p>
