...
- **Mobile builder quick-input** — collapsed card on mobile showing only rate/term/price/down; generates share link without full ScenarioBuilder; LO can use at the table with a borrower
